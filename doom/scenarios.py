...
SCENARIOS = {
    "basic": {
        ...
        "reward_defaults": {
            "kill_reward": 0, "miss_penalty": 0, "step_penalty": 0,
            "damage_penalty": 0, "ammo_penalty": 0,
        },
    },
    "deadly_corridor_s1": {
        "config_file": "deadly_corridor_s1.cfg",
        "num_actions": 7,
        ...
        "description": "Navigate a corridor full of enemies. Skill level 1 (easiest).",
        "default_hyperparams": {
    ...
    "deadly_corridor_s2": {
        "config_file": "deadly_corridor_s2.cfg",
        "num_actions": 7,
        "buttons": ["MOVE_LEFT", "MOVE_RIGHT", "ATTACK", "MOVE_FORWARD",
                     "MOVE_BACKWARD", "TURN_LEFT", "TURN_RIGHT"],
        "game_variables": ["HEALTH", "DAMAGE_TAKEN", "HITCOUNT", "SELECTED_WEAPON_AMMO"],
        "description": "Navigate a corridor full of enemies. Skill level 2.",
        "default_hyperparams": {
            "learning_rate": 0.00001,
            "n_steps": 8192,
            "clip_range": 0.1,
    ...
    "deadly_corridor_s5": {
        "config_file": "deadly_corridor_s5.cfg",
        "num_actions": 7,
        "buttons": ["MOVE_LEFT", "MOVE_RIGHT", "ATTACK", "MOVE_FORWARD",
                     "MOVE_BACKWARD", "TURN_LEFT", "TURN_RIGHT"],
        "game_variables": ["HEALTH", "DAMAGE_TAKEN", "HITCOUNT", "SELECTED_WEAPON_AMMO"],
        "description": "Navigate a corridor full of enemies. Skill level 5 (hardest).",
        "default_hyperparams": {
            "learning_rate": 0.0001,
            "n_steps": 2048,
            "clip_range": 0.2,
